	...
	?>
		<?php if ( comments_open( $post_id )  ) : ?>
			...
			<div id="respond" class="comment-respond">
				<span class="header1">Comments</span>
				...
				<?php else : ?>
					<form action="<?php echo site_url( '/wp-comments-post.php' ); ?>" method="post" id="<?php echo esc_attr( $args['id_form'] ); ?>" class="comment-form"<?php echo $html5 ? ' novalidate' : ''; ?>>
						...
						$commenttag =   '<div class="wrap-comment"><div class="avatar-block-img">'.'</div><div class="avatar-coment"> <textarea id="comment" name="comment" cols="45" rows="8" aria-describedby="form-allowed-tags" aria-required="true" placeholder="Write a Comment."></textarea></div>';

					 	echo apply_filters( 'comment_form_field_comment', $commenttag  );
						?>
						<?php echo $args['comment_notes_after']; ?>
						<div class="clear"></div>
						<div class="form-submit-button">
							<input name="<?php echo esc_attr( $args['name_submit'] ); ?>" type="submit" id="<?php echo esc_attr( $args['id_submit'] ); ?>" class="" value="<?php echo esc_attr( $args['label_submit'] ); ?>" />
