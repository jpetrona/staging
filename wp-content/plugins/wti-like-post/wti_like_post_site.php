...
function GetWtiLikePost($arg = null) {
     ...
     if (!in_array($post_id, $excluded_posts)) {
          ...
          $wti_like_post .= "<div class='watch-action' style='display:none'>";
		 ...
		 $wti_like_post .= "<i class='fa fa-thumbs-o-up post-like-up' aria-hidden='true'></i>";
          ...
          if ($show_dislike) {
              ...
              $wti_like_post .= "<a class='unlbg-" . $style . " unlike-" . $post_id . " jlk' href='javascript:void(0)' data-task='unlike' data-post_id='" . $post_id . "' data-nonce='" . $nonce . "' rel='nofollow'>";
			   ...
			   $wti_like_post .="<i class='fa fa-thumbs-o-down post-like-down' aria-hidden='true'></i>";
