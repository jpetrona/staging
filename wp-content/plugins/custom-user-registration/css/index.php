...
// use the registered jquery and style above
	...
	function registration_form( $username, $password, $email) {
       ?>
		...
		<input type="text" class="form-control inpt" name="username" placeholder="Username" pattern="[A-Za-z].{2,}" required="required" value="">
		</div>
		 
		<div class="form-group mrgn-cls">
		<label for="password" class="form-lbl-text">Password <strong>*</strong></label>
		<input type="password" name="password" class="form-control inpt" placeholder="Password" required="required" value="">
		</div>
		 
		<div class="form-group mrgn-cls">
		<label for="email" class="form-lbl-text">Email <strong>*</strong></label>
		<input type="text" name="email" class="form-control inpt" placeholder="Email" required="required" value="">
		</div>
		 
		<div>
		<input type="submit" class="btn btn-default sign-btnn mrgn-cls" name="submit" value="Register"/>
		</form></div></div>
		<div class="sign-bottom"><?php echo do_shortcode("[TheChamp-Login]"); ?><div style="clear:both"></div>					 					 
				</div>
		</div></div></div>
		<?php
	}
...
';
			...
			if($send_mail){
				echo "<div class='sucess'>Thank You for the registration.Please check your<br> email for confirmation.</div>";
				}
