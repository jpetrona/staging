...
jQuery ( document ).ready ( function ( $ ) {
    ...
    $ ( "#fep-submit-post.active-btn" ).on ( 'click', function () {
        ...
        var uploadImage = uploadImageonMedia();
                ...
                $.ajax ( {
                    ...
                    success: function ( data, textStatus, XMLHttpRequest ) {
                        ...
                        if ( arr.success ) {
                           ...
                           window.location.href="//"+window.location.hostname+"/retirelynews/myprofile";
                        }
                        else
    ...
    function uploadImageonMedia() {
        ...
        $.ajax({
           ...
           success: function(response) {
            ...
            jQuery ( '#fep-featured-image-id' ).val ( response.attach_id );
            jQuery ( '#uploader1' ).val ( response.uploadfile );
            /*script for add video on post*/        
           },
    ...
    /// New way for Post submit and upload image

    // function functionImgUpload(callback) {
    //     new Ajax.Request('http://www.google.nl', {
    //         onSuccess: function(response) {
    //             $('output').innerHTML += "function1 done\n";
    //             callback();
    //         }
    //     });
    // }

    // function functionPostsubmit(callback) {
    //     new Ajax.Request('http://www.google.nl', {
    //         onSuccess: function(response) {
    //             $('output').innerHTML += "function2 done\n";
    //             callback();
    //         }
    //     });
    // }

    // function submitPostandImgdata() {
    //     functionImgUpload(function() {
    //         functionPostsubmit();
    //     });
    // }
