						...
						/* Buttons */
						{
							...
							onclick: function() {
								editor.windowManager.open( {
									...
									onsubmit: function( e ) {
										editor.insertContent( '[symple_button url="' + e.data.buttonUrl + '" color="' + e.data.buttonColor + '"  button_target="' + e.data.buttonLinkTarget + '" btnrel="' + e.data.buttonrel + '"]' + e.data.buttonText + '[/symple_button]');
									}
								});
							}
						}, // End button
