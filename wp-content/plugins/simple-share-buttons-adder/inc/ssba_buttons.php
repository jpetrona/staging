...
function ssba_facebook($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
    ...
    if ($arrSettings['ssba_image_set'] != 'custom') {
        ...
        $htmlShareButtons .= '<img src="' . plugins_url() . '/simple-share-buttons-adder/buttons/' . $arrSettings['ssba_image_set'] . '/facebook.png" title="Facebook" class="ssba ssba-img" alt="" />';
    }
    ...
    // if using custom images
        ...
        // show custom image
        $htmlShareButtons .= '<img src="' . $arrSettings['ssba_custom_facebook'] . '" title="Facebook" class="ssba ssba-img" alt="" />';
    }
...
function ssba_linkedin($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
    ...
    if ($arrSettings['ssba_image_set'] != 'custom') {
        ...
        // show ssba image
        $htmlShareButtons .= '<img src="' . plugins_url() . '/simple-share-buttons-adder/buttons/' . $arrSettings['ssba_image_set'] . '/linkedin.png" title="LinkedIn" class="ssba ssba-img" alt="" />';
    }
    ...
    // if using custom images
        ...
        // show custom image
        $htmlShareButtons .= '<img src="' . $arrSettings['ssba_custom_linkedin'] . '" alt="" title="LinkedIn" class="ssba ssba-img" />';
    }
