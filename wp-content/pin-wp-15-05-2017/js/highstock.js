...
(function(J, ea) {
    ...
    function Ka(a, b) {
        for (var c = "{", d = !1, e, f, g, h, i, j = [];
            ...
            if (d) {
                ...
                for (h = 0; h < i; h++) e =
                    e[g[h]];
                if (f.length) f = f.join(":"), g = /\.([0-9])/, h = O.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = z.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = la(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    var u, B = J.document,
        ...
        ha = B && B.createElementNS && !!B.createElementNS(Ra, "svg").createSVGRect,
        $b = Za && parseInt(La.split("Firefox/")[1],
            10) < 4,
        oa = B && !ha && !Ja && !!B.createElement("canvas").getContext,
        $a, eb, Wb = {},
        Kb = 0,
        qb, O, la, H, pa = function() {},
        $ = [],
        mb = 0,
        Ya = "div",
        ac = /^[0-9]+$/,
        ub = ["plotTop", "marginRight", "marginBottom", "plotLeft"],
        da, rb, zb, hb, Cb, Db, Eb, ib, jb, kb, Qb, Rb, Sb, Tb, Fb, Gb, Hb, K = {},
        z;
    z = J.Highcharts ? ea(16, !0) : {
        win: J
    };
    z.seriesTypes = K;
    var Sa = [],
        wa, qa, n, Ma, Lb, ra, D, R, M, fb, Ta;
    yb.prototype = {
        dSetter: function() {
            var a = this.paths[0],
                b = this.paths[1],
        ...
        run: function(a, b, c) {
            ...
            this.pos = 0;
            e.elem = this.elem;
            if (e() && Sa.push(e) === 1) e.timerId = setInterval(function() {
                for (f =
                    0; f < Sa.length; f++) Sa[f]() || Sa.splice(f--, 1);
    ...
    Ta = function(a) {
        for (var b = Sa.length; b--;)
            if (Sa[b].elem === a) Sa[b].stopped = !0
    };
    n = function(a, b) {
    ...
    M = function(a, b, c, d) {
        ...
        e = a.hcEvents;
        var f, g, h, i, c = c || {};
        if (B.createEvent && (a.dispatchEvent || a.fireEvent)) e = B.createEvent("Events"), e.initEvent(b, !0, !0), e.target = a, w(e, c), a.dispatchEvent ? a.dispatchEvent(e) : a.fireEvent(b, e);
        else if (e) {
            e = e[b] || [];
            f = e.length;
            h = function() {
    ...
    fb = function(a, b, c) {
        ...
        c.curAnim = C(b);
        for (h in b) g = new yb(a, c, h), f = null, h === "d" ? (g.paths = g.initPath(a, a.d, b.d), g.toD = b.d, d = 0, f = 1) : a.attr ? d = a.attr(h) : (d = parseFloat(wa(a, h)) || 0, h !== "opacity" && (e = "px")), f || (f = b[h]), f.match && f.match("px") && (f = f.replace(/px/g, "")), g.run(d, f, e)
    };
    if (J.jQuery) J.jQuery.fn.highcharts = function() {
        var a = [].slice.call(arguments);
        if (this[0]) return a[0] ? (new(z[Da(a[0]) ? a.shift() : "Chart"])(this[0],
            a[0], a[1]), this) : $[W(this[0], "data-highcharts-chart")]
    };
    B && !B.defaultView && (wa = function(a, b) {
        var c;
        c = {
            width: "clientWidth",
            height: "clientHeight"
    ...
    va.prototype = {
        ...
        init: function(a) {
            var b, c, d, e;
            if ((this.input = a) && a.stops) this.stops = ra(a.stops, function(a) {
                return new va(a[1])
            });
            else
    ...
    Y.prototype = {
        ...
        init: function(a, b) {
            this.element = b === "span" ? ca(b) : B.createElementNS(Ra, b);
            this.renderer = a
        },
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                f === "radialGradient" && o && !t(g.gradientUnits) && (h = g, g = C(g, d.getRadialAttr(o, h), {
                    gradientUnits: "userSpaceOnUse"
                }));
                for (q in g) q !== "id" && r.push(q, g[q]);
                for (q in k) r.push(k[q]);
                r = r.join(",");
                i[r] ? o = i[r].attr("id") : (g.id = o = "highcharts-" + Kb++, i[r] = j = d.createElement(f).attr(g).add(d.defs), j.radAttr = h, j.stops = [], n(k, function(a) {
        ...
        css: function(a) {
            ...
            if (e) {
                e = this.textWidth = a &&
                    a.width && d.nodeName.toLowerCase() === "text" && G(a.width) || this.textWidth;
                b && (a = w(b, c));
                this.styles = a;
                e && (oa || !ha && this.renderer.forExport) && delete a.width;
        ...
        on: function(a, b) {
            var c = this,
                d = c.element;
            eb && a === "click" ? (d.ontouchstart = function(a) {
        ...
        align: function(a, b, c) {
            ...
            f = e.alignedObjects;
            if (a) {
                if (this.alignOptions = a, this.alignByTranslate = b, !c || Da(c)) this.alignTo = d = c || "renderer", Aa(f, this), f.push(this), c = null
        ...
        getBBox: function(a, b) {
            ...
            f = p(b, this.rotation);
            g = f * na;
            e !== u && (q = ["", f || 0, i && i.fontSize, h.style.width].join(","), q = e === "" || ac.test(e) ? "num:" + e.toString().length + q : e + q);
            q && !a && (c = m[q]);
            if (!c) {
                if (h.namespaceURI === Ra || d.forExport) {
                    try {
                        l = this.fakeTS && function(a) {
                            n(h.querySelectorAll(".highcharts-text-shadow"),
                                function(b) {
                                    b.style.display = a
                                })
                        }, Za && k.textShadow ? (j = k.textShadow, k.textShadow = "") : l && l("none"), c = h.getBBox ? w({}, h.getBBox()) : {
                            width: h.offsetWidth,
        ...
        titleSetter: function(a) {
            ...
            b || (b = B.createElementNS(Ra, "title"), this.element.appendChild(b));
    ...
    xa.prototype = {
        ...
        init: function(a, b, c, d, e, f) {
            ...
            g = d.element;
            a.appendChild(g);
            a.innerHTML.indexOf("xmlns") === -1 && W(g, "xmlns", Ra);
            this.isSVG = !0;
            this.box = g;
            this.boxWrapper = d;
            this.alignedObjects = [];
            this.url = (Za || tb) && B.getElementsByTagName("base").length ? J.location.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
            this.createElement("desc").add().element.appendChild(B.createTextNode("Created with Highstock 4.2.2"));
            ...
            this.setSize(b, c, !1);
            var h;
            if (Za && a.getBoundingClientRect) this.subPixelFix = b = function() {
                I(a, {
                    left: 0,
                    top: 0
                });
                ...
                I(a, {
                    left: Fa(h.left) - h.left + "px",
                    top: Fa(h.top) - h.top + "px"
                })
            }, b(), D(J, "resize", b)
        },
        getStyle: function(a) {
        ...
        buildText: function(a) {
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = W(b, "x"), k = a.styles, l = a.textWidth, m = k && k.lineHeight, o = k && k.textShadow, q = k && k.textOverflow === "ellipsis", r = g.length, A = l && !a.added &&
                    this.box, T = function(a) {
                        return m ? G(m) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : k && k.fontSize || c.style.fontSize || 12, a).h
                    }, v = function(a) {
                        return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")
                    }; r--;) b.removeChild(g[r]);
            !f && !o && !q && e.indexOf(" ") === -1 ? b.appendChild(B.createTextNode(v(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, A && A.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g,
                "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), n(e, function(e, f) {
                var g, m = 0,
                ...
                n(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        var o = {},
                            r = B.createElementNS(Ra, "tspan"),
                            A;
                        h.test(e) && (A = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), W(r, "style", A));
                        i.test(e) && !d && (W(r, "onclick", 'location.href="' + e.match(i)[1] + '"'), I(r, {
                            cursor: "pointer"
                        }));
                        e = v(e.replace(/<(.|\n)*?>/g,
                            "") || " ");
                        if (e !== " ") {
                            ...
                            if (l) {
                                for (var o = e.replace(/([^\^])-/g, "$1- ").split(" "), p = g.length > 1 || f || o.length > 1 && k.whiteSpace !== "nowrap", x, n, t, u = [], s = T(r), y = 1, w = a.rotation, C = e, z = C.length;
                                    (p || q) && (o.length || u.length);) a.rotation = 0, x = a.getBBox(!0), t = x.width, !ha && c.forExport && (t = c.measureSpanWidth(r.firstChild.data, a.styles)), x = t > l, n === void 0 && (n = x), q && n ?
                                    (z /= 2, C === "" || !x && z < 0.5 ? o = [] : (x && (n = !0), C = e.substring(0, C.length + (x ? -1 : 1) * Fa(z)), o = [C + (l > 3 ? "\u2026" : "")], r.removeChild(r.firstChild))) : !x || o.length === 1 ? (o = u, u = [], o.length && (y++, r = B.createElementNS(Ra, "tspan"), W(r, {
                                        dy: s,
                                        x: j
                                    }), A && W(r, "style", A), b.appendChild(r)), t > l && (l = t)) : (r.removeChild(r.firstChild), u.unshift(o.pop())), o.length && r.appendChild(B.createTextNode(o.join(" ").replace(/- /g, "-")));
        ...
        symbol: function(a, b, c, d, e, f) {
            ...
            }, k = a.match(j)[1], a = Wb[k] || f && f.width && f.height && [f.width, f.height], h = this.image(k).attr({
                x: b,
                y: c
        ...
        symbols: {
            ...
            callout: function(a, b, c, d, e) {
                var f = E(e && e.r || 0, c, d),
                    ...
                    e = e && e.anchorY,
                    i;
                i = ["M", a + f, b, "L", a + c - f, b, "C", a + c, b, a + c, b, a + c, b + f, "L", a + c, b + d - f, "C", a + c, b + d, a + c, b + d, a + c - f, b + d, "L", a + f, b + d, "C", a, b + d, a, b + d, a, b + d - f, "L", a, b + f, "C", a, b, a, b, a + f,
                    b
                ];
        ...
        fontMetrics: function(a, b) {
            ...
            !a && b && J.getComputedStyle &&
                (b = b.element || b, a = (c = J.getComputedStyle(b, "")) && c.fontSize);
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            ...
            L = function() {
                ...
                if (z) {
                    if (!m) a = ja, b = (h ? -s : 0) + ja, k.box = m = d ? j.symbol(d, a, b, k.width, k.height, Ua) : j.rect(a, b, k.width, k.height, 0, Ua["stroke-width"]), m.isImg || m.attr("fill", "none"), m.add(k);
                    m.isImg || m.attr(w({
                        width: y(k.width),
                        height: y(k.height)
                    }, Ua));
    ...
    w(Y.prototype, {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (m !== this.cTT) {
                        ...
                        if (b.offsetWidth > k && /[ \-]/.test(b.textContent || b.innerText)) I(b, {
                            width: k + "px",
                            display: "block",
                            whiteSpace: l || "normal"
                        }), this.hasTextWidth = !0;
                        else if (this.hasTextWidth) I(b, {
                            width: "",
                            display: "",
                            whiteSpace: l || "nowrap"
                        }), this.hasTextWidth = !1;
        ...
        setSpanRotation: function(a, b, c) {
            ...
            d[e + (Za ? "Origin" : "-origin")] = d.transformOrigin = b * 100 + "% " +
                c + "px";
            I(this.element, d)
        },
                ...
                if (this.parentGroup = a) {
                    if (b = a.div, !b) {
                        ...
                        n(k.reverse(), function(a) {
                            var d, e = W(a.element, "class");
                            e && (e = {
                                className: e
                            });
                            b = a.div = a.div || ca(Ya, e, {
                                position: "absolute",
                                left: (a.translateX || 0) +
                                    "px",
    ...
    if (!ha && !oa) Z = {
        ...
        getSpanCorrection: function(a, b, c, d, e) {
            ...
            e && e !== "left" && (this.xCorr -= a * c * (f < 0 ? -1 : 1), d && (this.yCorr -= h * c * (g < 0 ? -1 : 1)), I(this.element, {
                textAlign: e
            }))
        },
        ...
        clip: function(a) {
            var b = this,
                c;
            a ? (c = a.members, Aa(c, b), c.push(b), b.destroyClip = function() {
                Aa(c, b)
            }, a = a.getCSS(b)) : (b.destroyClip && b.destroyClip(), a = {
                clip: sb ? "inherit" : "rect(auto)"
            });
            return b.css(a)
        },
        ...
        dSetter: function(a, b, c) {
            ...
            if (d)
                for (c = d.length; c--;) d[c].path = d[c].cutOff ? this.cutOffPath(a, d[c].cutOff) :
                    a;
            this.setAttr(b, a)
        },
        fillSetter: function(a, b, c) {
        ...
        rotationSetter: function(a, b, c) {
            c = c.style;
            this[b] = c[b] = a;
            c.left = -y(ia(a * na) + 1) + "px";
            c.top = y(aa(a * na)) + "px"
        },
        strokeSetter: function(a, b, c) {
            this.setAttr("strokecolor", this.renderer.color(a,
                c, b, this))
        },
    ...
    }, Z["stroke-opacitySetter"] = Z["fill-opacitySetter"], z.VMLElement = Z = ka(Y, Z), Z.prototype.ySetter = Z.prototype.widthSetter = Z.prototype.heightSetter = Z.prototype.xSetter, Z = {
        Element: Z,
        isIE8: La.indexOf("MSIE 8.0") > -1,
        init: function(a, b, c, d) {
            var e;
            this.alignedObjects = [];
            d = this.createElement(Ya).css(w(this.getStyle(d), {
                position: "relative"
            }));
            e = d.element;
        ...
        color: function(a,
            ...
            if (i) {
                var k, l, m = a.linearGradient || a.radialGradient,
                    ...
                    x, N = [],
                    ja = function() {
                        h = ['<fill colors="' + N.join(",") + '" opacity="', r, '" o:opacity2="', q, '" type="', i, '" ', v, 'focus="100%" method="any" />'];
                ...
                x[0] < 1 && a.push([1, x[1]]);
                n(a, function(a, b) {
                    g.test(a[1]) ? (f = va(a[1]), k = f.get("rgb"), l = f.get("a")) :
                        (k = a[1], l = 1);
                    N.push(a[0] * 100 + "% " + k);
                    b ? (r = l, A = k) : (q = l, p = k)
                });
                if (c === "fill")
                    if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, v = 'angle="' + (90 - X.atan((m - a) / (o - c)) * 180 / Ba) + '"', ja();
                    else {
                        var j = m.r,
                            Ua = j * 2,
                            t = j * 2,
                            ...
                            y = b.radialReference,
                            w, j = function() {
                                y && (w = d.getBBox(), u += (y[0] - w.x) / w.width - 0.5, s += (y[1] - w.y) / w.height - 0.5, Ua *= y[2] / w.width, t *= y[2] / w.height);
                                v = 'src="' + O.global.VMLRadialGradientURL + '" size="' + Ua + "," + t + '" origin="0.5,0.5" position="' + u + "," + s + '" color2="' +
                                    p + '" ';
                                ja()
                            };
                        d.added ? j() : d.onAdd = j;
    ...
    }, z.VMLRenderer = nb = function() {
        this.init.apply(this, arguments)
    }, nb.prototype = C(xa.prototype, Z), $a = nb;
    ...
    var Xb;
    if (oa) z.CanVGRenderer = Z = function() {
            Ra = "http://www.w3.org/1999/xhtml"
        }, Z.prototype.symbols = {}, Xb = function() {
            function a() {
                var a = b.length,
                    d;
                for (d = 0; d < a; d++) b[d]();
    ...
    db.prototype = {
        addLabel: function() {
            ...
            b = a.labelFormatter.call({
                ...
                value: a.isLog ? ma(za(e)) : e
            });
            t(d) ? d && d.attr({
                text: b
            }) : (this.labelLength = (this.label = d = t(b) && g.enabled ?
                c.renderer.text(b, 0, 0, g.useHTML).css(C(g.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0)
        },
        ...
        handleOverflow: function(a) {
            var b = this.axis,
                ...
                m, o = {};
            if (h) h < 0 && c - i *
                j < f ? m = y(c / aa(h * na) - f) : h > 0 && c + i * j > e && (m = y((d - c) / aa(h * na)));
            else if (d = c + (1 - i) * j, c - i * j < f ? k = a.x + k * (1 - i) - f : d > e && (k = e - a.x + k * i, l = -1), k = E(b.slotWidth, k), k < b.slotWidth && b.labelAlign === "center" && (a.x += l * (b.slotWidth - k - i * (b.slotWidth - E(j, k)))), j > k || b.autoRotation && g.styles.width) m = k;
            if (m) {
                o.width = m;
        ...
        getLabelPosition: function(a, b, c, d, e, f, g, h) {
            var i = this.axis,
                ...
                o = e.y;
            t(o) || (o = i.side === 2 ? m.y + 8 : o = aa(c.rotation * na) * (m.y - c.getBBox(!1, 0).height / 2));
            a = a + e.x + m.x - (f && d ? f * j * (k ? -1 : 1) : 0);
            b = b + o - (f && !d ? f * j * (k ? 1 : -1) : 0);
            l && (c = g / (h || 1) % l, i.opposite && (c = l - c - 1), b += c * (i.labelOffset /
                l));
            return {
                x: a,
                y: y(b)
        ...
        render: function(a, b, c) {
            ...
            if (m && n) x === "inside" && (n = -n), d.opposite && (n = -n), h = this.getMarkPath(y, s, n, m * w, g, f), o ? o.animate({
                d: h,
                opacity: c
            ...
            if (i && !isNaN(y)) i.xy = s = this.getLabelPosition(y, s, i, g, k, t, a, N), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? ja = !1 : g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(s), N && a % N && (ja = !1), ja && !isNaN(s.y) ? (s.opacity = c, i[this.isNew ? "attr" : "animate"](s), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function() {
            Qa(this, this.axis)
        }
    ...
    z.PlotLineOrBand.prototype = {
        render: function() {
            ...
            e && t(e.text) && o && o.length && b.width > 0 && b.height > 0 && !o.flat ? (e = C({
                align: c && j && "center",
                x: c ? !j && 4 : 10,
                verticalAlign: !c && j && "middle",
                y: c ? j ? 16 : 10 : j ? 6 : -4,
                rotation: c && !j && 90
            }, e), this.renderLabel(e, o, j, A)) : f && f.hide();
            return a
        },
    ...
    F.prototype = {
        ...
        defaultYAxisOptions: {
            ...
            stackLabels: {
                ...
                style: C(V.line.dataLabels.style, {
                    color: "#000000"
                })
            }
        },
        ...
        init: function(a, b) {
            ...
            this.crosshair =
                p(d.crosshair, ua(a.options.tooltip.crosshairs)[c ? 0 : 1], !1);
            ...
            if (this.isLog) this.val2lin = Oa, this.lin2val = za
        },
        setOptions: function(a) {
            this.options = C(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], C(O[this.coll], a))
        },
        defaultLabelFormatter: function() {
            ...
            if (h) g = Ka(h, this);
                ...
                for (; f-- && g === u;) c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !==
                ...
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (d = c.xData, d.length) a.dataMin = E(p(a.dataMin, d[0]),
                            Pa(d)), a.dataMax = s(p(a.dataMax, d[0]), Ea(d))
                    } else {
                        c.getExtremes();
                        f = c.dataMax;
                        c = c.dataMin;
        ...
        translate: function(a, b, c, d, e, f) {
            ...
            b ? (a = a * h + i, a -= k, a = a / j + d, e && (a = g.lin2val(a))) : (e && (a = g.val2lin(a)), f === "between" && (f = 0.5), a = h * (a - d) * j + i + h * k + (ta(f) ? j * f * g.pointRange : 0));
            return a
        },
        ...
        adjustForMinRange: function() {
            var a =
                ...
                f, g, h, i, j, k;
            if (this.isXAxis && this.minRange === u && !this.isLog) t(a.min) || t(a.max) ? this.minRange = null : (n(this.series, function(a) {
                i = a.xData;
        ...
        setAxisTranslation: function(a) {
            ...
            if (k || i || d)
                if (h ? (f = h.minPointOffset, g = h.pointRangePadding) : (n(b.series, function(a) {
                        ...
                        d = s(d, c);
                        b.single || (f = s(f, Da(a) ? 0 : c / 2),
                            g = s(g, a === "on" ? 0 : c))
                    })), h = b.ordinalSlope && e ? b.ordinalSlope / e : 1, b.minPointOffset = f *= h, b.pointRangePadding = g *= h, b.pointRange = E(d, c), k) b.closestPointRange = e;
            if (a) b.oldTransA = j;
        ...
        setTickInterval: function(a) {
            ...
            T = p(b.userMin, d.min);
            v = p(b.userMax, d.max);
            h ? (b.linkedParent = c[b.coll][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = p(c.min, c.dataMin), b.max = p(c.max, c.dataMax), d.type !== b.linkedParent.options.type && ea(11, 1)) : (!q && t(o) && (b.dataMin >= o ? (r = o, j = 0) : b.dataMax <= o && (A = o, i = 0)), b.min = p(T, r, b.dataMin), b.max = p(v, A, b.dataMax));
            if (e) !a && E(b.min, p(b.dataMin, b.min)) <= 0 && ea(10, 1), b.min = ma(Oa(b.min), 15), b.max = ma(Oa(b.max), 15);
            if (b.range && t(b.max)) b.userMin = b.min = T = s(b.min, b.minFromRange()), b.userMax = v = b.max, b.range = null;
            b.beforePadding && b.beforePadding();
            b.adjustForMinRange();
            if (!m && !b.axisPointRange && !b.usePercentage && !h && t(b.min) && t(b.max) && (c = b.max - b.min)) !t(T) && j && (b.min -= c * j), !t(v) && i && (b.max += c * i);
            ...
            b.tickInterval = b.min === b.max ||
                b.min === void 0 || b.max === void 0 ? 1 : h && !k && l === b.linkedParent.options.tickPixelInterval ? k = b.linkedParent.tickInterval : p(k, this.tickAmount ? (b.max - b.min) / s(this.tickAmount - 1, 1) : void 0, m ? 1 : (b.max - b.min) * l / s(b.len, l));
            ...
            if (b.pointRange && !k) b.tickInterval = s(b.pointRange,
                b.tickInterval);
            a = p(d.minTickInterval, b.isDatetimeAxis && b.closestPointRange);
            if (!k && b.tickInterval < a) b.tickInterval = a;
            if (!f && !e && !k) b.tickInterval = Bb(b.tickInterval, null, Ab(b.tickInterval), p(d.allowDecimals, !(b.tickInterval > 0.5 && b.tickInterval < 5 && b.max > 1E3 && b.max < 9999)), !!this.tickAmount);
        ...
        setTickPositions: function() {
            var a = this.options,
                ...
                g;
            this.tickmarkOffset =
                this.categories && a.tickmarkPlacement === "between" && this.tickInterval === 1 ? 0.5 : 0;
        ...
        getExtremes: function() {
            var a = this.isLog;
            return {
                min: a ? ma(za(this.min)) : this.min,
                max: a ? ma(za(this.max)) : this.max,
        ...
        unsquish: function() {
            ...
            c ? (l = !b.staggerLines && !b.step && (t(h) ? [h] : f < p(b.autoRotationLimit, 80) && b.autoRotation)) && n(l, function(a) {
                var b;
                if (a === h || a && a >= -90 && a <= 90) j = m(Q(i.h / ia(na * a))), b = j + Q(a / 360), b < k && (k = b, g = a, e = j)
            }) : b.step || (e = m(i.h));
            this.autoRotation =
                l;
        ...
        renderUnsquish: function() {
            ...
            if (j.rotation && (l = {
                    width: (m > a.chartHeight * 0.5 ? a.chartHeight * 0.33 : a.chartHeight) +
                        "px"
        ...
        getOffset: function() {
            ...
            }).add(ja), a.axisGroup = c.g("axis").attr({
                zIndex: d.zIndex || 2
            }).add(ja), a.labelGroup = c.g("axis-labels").attr({
                zIndex: r.zIndex || 7
            }).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add(ja);
            if (j || a.isLinked) {
                if (n(e, function(b) {
                ...
                for (N in f) f[N].destroy(), delete f[N];
        ...
        render: function() {
            ...
            if (a.hasData() || f) {
                ...
                if (g.length && (n(g, function(b, c) {
                    ...
                    (i[-1] = new db(a, -1, null, !0)), i[-1].render(-1);
                m && n(g, function(c, d) {
                    N = g[d + 1] !== u ? g[d + 1] + o : a.max - o;
                    if (d % 2 === 0 && c < a.max && N <= a.max + (b.polar ? -o : o)) k[c] || (k[c] = new z.PlotLineOrBand(a)), x = c + o, k[c].options = {
                        from: e ? za(x) : x,
                        to: e ? za(N) : N,
                        color: m
        ...
        redraw: function() {
            this.visible && (this.render(), n(this.plotLinesAndBands,
                function(a) {
                    a.render()
                }));
        ...
        drawCrosshair: function(a, b) {
            var c, d = this.crosshair,
                e, f;
            if (!this.crosshair ||
                (t(b) || !p(d.snap, !0)) === !1) this.hideCrosshair();
            else if (p(d.snap, !0) ? t(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null, c === null) this.hideCrosshair();
    ...
    F.prototype.getTimeTicks = function(a, b, c,
        d) {
        var e = [],
            f = {},
            g = O.global.useUTC,
        ...
        if (t(b)) {
            ...
            b = 1;
            if (zb || hb) i = i.getTime(), i = new da(i +
                gb(i));
            h = i[kb]();
            for (var d = i.getTime(), l = i[jb](), m = i[ib](), o = !g || !!hb, q = (H.day + (g ? gb(i) : i.getTimezoneOffset() * 6E4)) % H.day; d < c;) e.push(d), j === H.year ? d = rb(h + b * k, 0) : j === H.month ? d = rb(h, l + b * k) : o && (j === H.day || j === H.week) ? d = rb(h, l, m + b * k * (j === H.day ? 1 : 7)) : d += j * k, b++;
            e.push(d);
            n(Ma(e, function(a) {
    ...
    F.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5) a = y(a), g = this.getLinearTickPositions(a, b, c);
            ...
            for (var f = U(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
                i = e.length;
                for (h = 0; h < i && !l; h++) j = Oa(za(f) * e[h]), j > b && (!d || k <= c) && k !== u && g.push(k), k > c && (l = !0), k = j
            } else if (b = za(b), c = za(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = Bb(a, null, Ab(a)), g = ra(this.getLinearTickPositions(a,
                    b, c), Oa), !d) this._minorAutoInterval = a / 5;
    ...
    Mb.prototype = {
        ...
        refresh: function(a, b) {
            ...
            j === !1 ? this.hide() : (this.isHidden && (Ta(d), d.attr("opacity", 1).show()), d.attr({
                text: j
    ...
    ab.prototype = {
        ...
        runPointActions: function(a) {
            ...
            g && (e ? g.noSharedTooltip : g.directTouch) && f ? l = [f] : (n(c, function(b) {
                i = b.noSharedTooltip && e;
                j = !e &&
                    b.directTouch;
                b.visible && !i && !j && p(b.options.enableMouseTracking, !0) && (m = b.searchPoint(a, !i && b.kdDimensions === 1)) && k.push(m)
            }), n(k, function(a) {
            ...
            if (e)
                for (b = k.length; b--;)(k[b].clientX !== l[1].clientX || k[b].series.noSharedTooltip) && k.splice(b, 1);
            if (l[0] && (l[0] !== this.prevKDPoint || d && d.isHidden))
                if (e && !l[0].series.noSharedTooltip) k.length && d && d.refresh(k, a), n(k, function(b) {
            ...
            if (!this._onDocumentMouseMove) this._onDocumentMouseMove = function(a) {
                if ($[sa]) $[sa].pointer.onDocumentMouseMove(a)
            }, D(B, "mousemove", this._onDocumentMouseMove);
            n(e ? k : [p(l[1], f)], function(b) {
                var c = b && b.series;
                c && n(["xAxis", "yAxis", "colorAxis"], function(d) {
                    c[d] &&
        ...
        reset: function(a, b) {
            ...
            if (a) g.refresh(h), e && (e.setState(e.state, !0), n(c.axes, function(a) {
                ...
                if (d) d.onMouseOut();
                g && g.hide(b);
                if (this._onDocumentMouseMove) R(B, "mousemove",
        ...
        drag: function(a) {
            ...
            if (!m || !m.touch)
                if (d < h ? d = h : d > h + j && (d = h + j), e < i ? e = i : e > i + k && (e = i + k), this.hasDragged = Math.sqrt(Math.pow(o - d, 2) + Math.pow(q - e, 2)), this.hasDragged > 10) {
                    l = b.isInsidePlot(o - h, q - i);
                    if (b.hasCartesianSeries &&
                        (this.zoomX || this.zoomY) && l && !r && !m) this.selectionMarker = m = b.renderer.rect(h, i, f ? 1 : j, g ? 1 : k, 0).attr({
        ...
        onContainerMouseMove: function(a) {
            ...
            var b = this.chart;
            if($[sa]!=undefined) { if (!t(sa) || !$[sa].mouseIsDown) sa = b.index;}else{ sa=0;}
            a = this.normalize(a);
            a.returnValue = !1;
        ...
        onContainerClick: function(a) {
            var b = this.chart,
                ...
                e = b.plotTop,
                a = this.normalize(a);
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (M(c.series, "click", w(a, {
                    point: c
                })),
                b.hoverPoint && c.firePointEvent("click", a)) : (w(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && M(b, "click", a)))
        },
        setDOMEvents: function() {
            ...
            if (eb) b.ontouchstart = function(b) {
    ...
    w(z.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a,
            ...
            var i = this.chart,
                ...
                u = !x && c[1][l],
                y, c = function() {
                    !x && Q(N - t) > 20 && (A = h || Q(s - u) / Q(N - t));
                    r = (o - s) / A + N;
                    q = i["plot" + (a ? "Width" : "Height")] / A
                };
            c();
            b = r;
            b < n.min ? (b = n.min, y = !0) : b + q > n.max && (b = n.max - q, y = !0);
            y ? (s -= 0.8 * (s - g[j][0]), x || (u -= 0.8 * (u - g[j][1])), c()) : g[j] = [s, u];
            p || (f[j] = r - o, f[m] = q);
            f = p ? 1 / A : A;
            e[m] = q;
            e[j] = b;
    ...
    if (J.PointerEvent || J.MSPointerEvent) {
        var Ga = {},
            ...
            Ob = function(a, b, c, d) {
                if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && $[sa]) d(a), d = $[sa].pointer, d[b]({
                    type: c,
        ...
        w(ab.prototype, {
            ...
            batchMSEvents: function(a) {
                ...
                a(this.chart.container, Nb ? "pointermove" : "MSPointerMove",
    ...
    vb.prototype = {
        init: function(a, b) {
            var c =
                ...
                e = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.itemStyle = d, c.itemHiddenStyle = C(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), D(c.chart, "endResize", function() {
        ...
        renderItem: function(a) {
            ...
            if (!A) {
                ...
                a.legendItem = A = c.text("",
                    l ? f + g : -g, this.baseline || 0, x).css(C(a.visible ? h : i)).attr({
                    align: l ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup);
                if (!this.baseline) this.fontMetrics = c.fontMetrics(h.fontSize, A), this.baseline = this.fontMetrics.f + 3 + q, A.attr("y", this.baseline);
            ...
            this.itemHeight = g = y(a.legendItemHeight ||
                c.height);
            if (e && this.itemX - r + f > (m || b.chartWidth - 2 * j - r - d.x)) this.itemX = r, this.itemY += q + this.lastLineHeight + o, this.lastLineHeight = 0;
        ...
        adjustMargins: function(a, b) {
            ...
            this.display && !d.floating && n([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function(f, g) {
                f.test(e) && !t(a[g]) && (c[ub[g]] = s(c[ub[g]], c.legend[(g + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][g] * d[g % 2 ? "x" : "y"] + p(d.margin, 12) + b[g]))
            })
        },
        render: function() {
            var a = this,
        ...
        handleOverflow: function(a) {
            ...
            if (a > f) {
                ...
                b.scroll(0);
                a = f
            } else if (m) T(c.chartHeight), m.hide(), this.scrollGroup.attr({
                translateY: 1
            }), this.clipHeight = 0;
            return a
        },
        scroll: function(a, b) {
            ...
            e > d && (e = d);
            if (e >
                0) b !== u && cb(b, this.chart), this.nav.attr({
                translateX: j,
    ...
    (/Trident\/7\.0/.test(La) || Za) && S(vb.prototype, "positionItem", function(a, b) {
        var c = this,
            d = function() {
    ...
    Ca.prototype = {
        ...
        layOutTitles: function(a) {
            ...
            }, e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = Fa(b + d.getBBox().height)));
        ...
        cloneRenderTo: function(a) {
            var b = this.renderToClone,
                c = this.container;
            a ? b && (this.renderTo.appendChild(c), Xa(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c),
                this.renderToClone = b = this.renderTo.cloneNode(0), I(b, {
                    position: "absolute",
                    top: "-9999px",
                    display: "block"
        ...
        getContainer: function() {
            ...
            this.renderer = new(z[c.renderer] || $a)(a, d, e, c.style,
        ...
        reflow: function(a) {
            ...
            if (!b.hasUserSize && !b.isPrinting && e && f && (c === J || c === B)) {
                if (e !== b.containerWidth || f !== b.containerHeight) clearTimeout(b.reflowTimeout), b.reflowTimeout = bb(function() {
        ...
        setChartSize: function(a) {
            ...
            this.clipBox = {
                x: b,
                y: c,
                width: U(this.plotSizeX - s(d, h[1]) / 2 - b),
                height: s(0,
                    U(this.plotSizeY - s(d, h[2]) / 2 - c))
            };
        ...
        drawChartBox: function() {
            ...
            if (k) f ? f.animate(n) : this.plotBackground = b.rect(q, r, A, p, 0).attr({
                fill: k
            ...
            if (m) g ? g.animate(g.crisp({
                ...
                height: p,
                strokeWidth: -m
            })) : this.plotBorder = b.rect(q, r, A, p, 0, -m).attr({
        ...
        linkSeries: function() {
            ...
            n(b, function(b) {
                ...
                if (Da(d) && (d = d === ":previous" ? a.series[b.index - 1] : a.get(d))) d.linkedSeries.push(b), b.linkedParent = d, b.visible = p(b.options.visible, d.options.visible, b.visible)
            })
        },
        ...
        isReadyToRender: function() {
            var a = this;
            return !ha && J == J.top && B.readyState !== "complete" || oa && !J.canvg ? (oa ? Xb.push(function() {
                a.firstRender()
    ...
    P.prototype = {
        ...
        setOptions: function(a) {
            ...
            this.userOptions = a;
            c = C(e, c.series, a);
            this.tooltipOptions = C(O.tooltip, O.plotOptions[this.type].tooltip, b.tooltip, d.series && d.series.tooltip, d[this.type] && d[this.type].tooltip, a.tooltip);
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) n(a, function(a, b) {
                ...
                if (o && h > o) {
                    ...
                    if (ta(k)) {
                        ...
                        if (A)
                            for (c = 0; c < h; c++) k = a[c], q[c] = k[0], r[c] = k.slice(1, A + 1);
                        else
                            for (c = 0; c < h; c++) k = a[c], q[c] = k[0], r[c] = k[1];
                    else ea(12)
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== u && (k = {
                                ...
                                c), m && t(k.name))) l.names[k.x] = k.name;
                Da(r[0]) && ea(14, !0);
                e.data = [];
        ...
        processData: function(a) {
            ...
            if (l && this.sorted && !k && (!i || d > i || this.forceCrop))
                ...
                else if (b[0] < o || b[d - 1] > q) e = this.cropData(this.xData, this.yData, o, q), b = e.xData, c = e.yData, e = e.start, f = !0;
            for (i = b.length || 1; --i;) d = m ? j(b[i]) - j(b[i - 1]) : b[i] - b[i - 1], d > 0 && (g === u || d < g) ? g = d : d < 0 && this.requireSorting && ea(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        getExtremes: function(a) {
            ...
            for (l = 0; l < d; l++)
                if (j = c[l], k = a[l], i = k !== null && k !==
                    u && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h, i && j)
                    if (i = k.length)
        ...
        translate: function() {
            ...
            this.generatePoints();
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || ta(i), k = a.threshold,
                ...
                if (b && this.visible && !n.isNull && N && N[v]) r = this.getStackIndicator(r, v, this.index), N = N[v], x = N.points[r.key], o = x[0], x = x[1], o === l && (o = p(k, e.min)), e.isLog && o <= 0 && (o = null), n.total = n.stackTotal = N.total, n.percentage = N.total && n.y /
                    N.total * 100, n.stackY = x, N.setOffset(this.pointXOffset || 0, this.barW || 0);
        ...
        getValidPoints: function() {
            return Ma(this.points, function(a) {
                return !a.isNull
            })
        },
        setClip: function(a) {
        ...
        drawPoints: function() {
            var a, b = this.points,
                ...
                s =
                p(l.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * l.radius);
            if (l.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = U(g.plotX), e = g.plotY, k = g.graphic, o = g.marker || {}, q = !!g.marker, a = s && o.enabled === u || o.enabled, r = g.isInside, a && e !== u && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = p(o.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[r ? "show" : "hide"](!0).attr(a).animate(w({
                            x: d - h,
                            y: e - h
                        }, k.symbolName ? {
                            width: 2 * h,
                            ...
                            if (r && (h > 0 || j)) g.graphic =
                                c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, q ? o : l).attr(a).add(n)
                        }
        ...
        getAttribs: function() {
            ...
            if (!k || g < k || j)
                for (; g--;) {
                    k = i[g];
                    if ((c = k.options && k.options.marker ||
                            k.options) && c.enabled === !1) c.radius = 0;
                    if (r.length) {
                        j = 0;
                    ...
                    if (k.options)
                        for (s in m) t(c[m[s]]) && (j = !0);
                    if (j) {
                        c = c || {};
                        j = [];
                        d = c.states || {};
                        f = d.hover = d.hover || {};
                        if (!b.marker || k.negative && !f.fillColor && !e.fillColor) f[a.pointAttrToOptions.fill] = f.color || !k.options.color && e[k.negative && h ? "negativeColor" : "color"] || va(k.color).brighten(f.brightness || e.brightness).get();
                        f = {
                            color: k.color
                        };
        ...
        getGraphPath: function(a, b, c) {
            ...
            n(a, function(i, j) {
                var k = i.plotX,
                    l = i.plotY,
                    m = a[j - 1];
                if ((i.leftCliff || m && m.rightCliff) && !c) h = !0;
                i.isNull && !t(b) && j > 0 ? h = !e.connectNulls : i.isNull && !b ? h = !0 : (j === 0 || h ? m = ["M", i.plotX,
                    i.plotY
                ] : d.getPointSpline ? m = d.getPointSpline(a, i, j) : f ? (m = f === "right" ? ["L", m.plotX, l] : f === "center" ? ["L", (m.plotX + k) / 2, m.plotY, "L", (m.plotX + k) / 2, l] : ["L", k, m.plotY], m.push("L", k, l)) : m = ["L", k, l], g.push.apply(g, m), h = !1)
            });
        ...
        applyZones: function() {
            var a = this,
                ...
                r = l.horiz,
                A, T, v, x = !1;
            if (d.length && (i || j) && l.min !== u) i && i.hide(), j && j.hide(), m = l.getExtremes(), n(d, function(d, n) {
    ...
    P.prototype.setStackedPoints = function() {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            ...
            for (v = 0; v < d; v++) {
                ...
                n = (r = k && t < (g ? 0 : f)) ? j : i;
                m[n] || (m[n] = {});
                if (!m[n][x]) o[n] && o[n][x] ? (m[n][x] = o[n][x], m[n][x].total = null) : m[n][x] = new Ub(l, l.options.stackLabels, r, x, h);
                n = m[n][x];
                if (t !== null) n.points[T] = n.points[this.index] = [p(n.cum, g)], n.touched = l.stacksTouched, q.index > 0 && this.singleStacks === !1 && (n.points[T][0] =
                    n.points[this.index + "," + x + ",0"][0]);
                e === "percent" ? (r = r ? i : j, k && m[r] && m[r][x] ? (r = m[r][x], n.total = r.total = s(r.total, n.total) + Q(t) || 0) : n.total = ma(n.total + (Q(t) || 0))) : n.total = ma(n.total + (t || 0));
                n.cum = p(n.cum, g) + (t || 0);
    ...
    P.prototype.setPercentStacks = function() {
        ...
        n([b, "-" + b], function(b) {
            ...
            for (var g = d.length, h, i; g--;)
                if (h = d[g],
                    e = a.getStackIndicator(e, h, a.index), f = (i = c[b] && c[b][h]) && i.points[e.key], h = f) i = i.total ? 100 / i.total : 0, h[0] = ma(h[0] * i), h[1] = ma(h[1] * i), a.stackedYData[g] = h[1]
        })
    };
    ...
    w(Ca.prototype, {
        ...
        showLoading: function(a) {
            ...
            if (!d) b.loadingDiv = d = ca(Ya, {
                className: "highcharts-loading"
            }, w(e.style, {
                zIndex: 10,
                display: "none"
            }), b.container), b.loadingSpan = ca("span", null, e.labelStyle, d), D(b, "redraw", f);
            b.loadingSpan.innerHTML =
                a || c.lang.loading;
            if (!b.loadingShown) I(d, {
                opacity: 0,
                display: ""
            }), fb(d, {
    ...
    w(Ha.prototype, {
        update: function(a, b, c, d) {
            function e() {
                ...
                if (fa(a) && !Na(a)) f.redraw = function() {
                    if (h && h.element &&
                        a && a.marker && a.marker.symbol) f.graphic = h.destroy();
    ...
    w(P.prototype, {
        ...
        removePoint: function(a, b, c) {
            var d = this,
                ...
                i = function() {
                    g &&
                        g.length === e.length && g.splice(a, 1);
                    e.splice(a, 1);
            ...
            if (this.options.stacking) {
                ...
                n(b, function(g, i) {
                    var o = 0,
                        p, v;
                    if (f[g] &&
                        !f[g].isNull) a.push(f[g]), n([-1, 1], function(a) {
                        var c = a === 1 ? "rightNull" : "leftNull",
                            d = 0,
                            o = e[b[i + a]];
                        if (o)
                            for (m = h; m >= 0 && m < j;) p = o.points[m], p || (m === h ? f[g][c] = !0 : k[m] && (v = e[g].points[m]) && (d -= v[1] - v[0])), m += l;
        ...
        getGraphPath: function(a) {
            var b = P.prototype.getGraphPath,
                ...
                r = function(b, c, f) {
                    ...
                    r !== void 0 && (i.push({
                        plotX: k,
                        plotY: r === null ? o : e.toPixels(r, !0),
                        isNull: g
                    }), h.push({
                        plotX: k,
                        plotY: n === null ? o : e.toPixels(n, !0)
                    }))
                },
                a = a || this.points;
            ...
            for (f = 0; f < a.length; f++)
                if (g = a[f].isNull,
                    k = p(a[f].rectPlotX, a[f].plotX), q = p(a[f].yBottom, o), !g || c) {
                    c || r(f, f - 1, "left");
    ...
    Ia = ka(P, {
        ...
        translate: function() {
            ...
            n(a.points, function(c) {
                var d = E(p(c.yBottom, f), 9E4),
                    ...
                    n = E(h, d),
                    t, v = s(h, d) - n;
                Q(v) < g && g && (v = g, t = !e.reversed && !c.negative || e.reversed && c.negative, n = Q(n - f) > g ? d - g : f - (t ? g : 0));
                c.barX = q;
                c.pointWidth = i;
        ...
        drawPoints: function() {
            ...
            n(a.points, function(h) {
                var i = h.plotY,
                    j = h.graphic;
                if (i !== u && !isNaN(i) && h.y !== null) f = h.shapeArgs, i = t(a.borderWidth) ? {
                    "stroke-width": a.borderWidth
                } : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ? (Ta(j), j.attr(i).attr(g)[b.pointCount < e ? "animate" : "attr"](C(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(h.group || a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
        ...
        animate: function(a) {
            var b =
                ...
                e = {};
            if (ha) a ? (e.scaleY = 0.001, a = E(b.pos + b.len, s(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
        },
        remove: function() {
            var a = this,
                b = a.chart;
    ...
    ba = {
        ...
        translate: function(a) {
            ...
            for (m = 0; m < o; m++) {
                ...
                q.angle = h;
                e = E(e, l / 2);
                q.labelPos = [a[0] + f + aa(h) * l, a[1] + g + ia(h) * l, a[0] + f + aa(h) * e, a[1] + g + ia(h) * e, a[0] + f, a[1] + g, l < 0 ? "center" : q.half ? "right" : "left", h]
            }
        },
        drawGraph: null,
        drawPoints: function() {
        ...
        if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (j.attr({
            ...
            if (o && !h) e.dataLabel = o.destroy();
                ...
                if (o)
                    ...
                    if (v.color === "contrast") x.color = d.inside || d.distance < 0 || b.stacking ? k.getContrast(e.color || a.color) : "#000000";
                    if (c) x.cursor = c;
                    for (r in o) o[r] === u && delete o[r];
                    o = e.dataLabel = k[h ? "text" : "label"](i, 0, -9999, d.shape, null, null, d.useHTML).attr(o).css(w(v, x)).add(j).shadow(d.shadow)
                }
    ...
    P.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (o) d = w({
            ...
            width: j.width,
            height: j.height
        }), l ? (q = !1, g = f.renderer.rotCorr(k, l), g = {
                x: d.x + c.x + d.width / 2 + g.x,
                y: d.y + c.y + d.height / 2
            }, b[e ? "attr" : "animate"](g).attr({
                align: c.align
            }),
            h = (l + 720) % 360, h = h > 180 && h < 360, m === "left" ? g.y -= h ? j.height : 0 : m === "center" ? (g.x -= j.width / 2, g.y -= j.height / 2) : m === "right" && (g.x -= j.width, g.y -= h ? 0 : j.height)) : (b.align(c, null, d), g = b.alignAttr), q ? this.justifyDataLabel(b, c, g, j, d, e) : p(c.crop, !0) && (o = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)), c.shape && !l && b.attr({
            anchorX: a.plotX,
            anchorY: a.plotY
        });
        if (!o) Ta(b), b.attr({
    ...
    if (K.pie) K.pie.prototype.drawDataLabels = function() {
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                for (B = 2; B--;) {
                    ...
                    if (F) {
                        ...
                        for (L = b = 0; !b && I[L];) b = I[L] && I[L].dataLabel && (I[L].dataLabel.getBBox().height || 21),
                            L++;
                        if (m > 0) {
                            ...
                            for (L = 0; L < F; L++) {
                                ...
                                if (H < L && G[L] !== null) H = L;
                                    ...
                                    for (v < F - L + H && G[L] !== null && (H = v - F + L); G[H] === null;) H++;
                                K.push({
                                    i: H,
                                    y: G[H]
                                });
                        ...
                        for (L = 0; L < F; L++) {
                            ...
                            c = x[1];
                            if (m > 0) {
                                if (v = K.pop(), H = v.i, z = v.y, c > z && G[H + 1] !== null || c < z && G[H - 1] !== null) z = E(s(0, c), d.plotHeight)
                            } else z = c;
                            ...
                            t.connX = w;
                            t.connY = z;
                            if (this.options.size === null) v = t.width, w - v < f ? D[3] = s(y(v - w + f), D[3]) : w + v > h - f && (D[1] = s(y(w + v - h + f), D[1])), z - b / 2 < 0 ? D[0] = s(y(-z + b / 2), D[0]) : z + b / 2 > i && (D[2] = s(y(z + b / 2 - i), D[2]))
                        }
                    }
                }
                if (Ea(D) === 0 || this.verifyDataLabelOverflow(D)) this.placeDataLabels(),
                    A && g && n(this.points, function(b) {
                        j = b.connector;
                        x = b.labelPos;
                        if ((t = b.dataLabel) && t._pos && b.visible) C = t._attr.visibility, w = t.connX, z = t.connY, k = l ? ["M", w + (x[6] === "left" ? 5 : -5), z, "C", w, z, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", w + (x[6] === "left" ? 5 : -5), z, "L", x[2], x[3], "L", x[4], x[5]], j ? (j.animate({
                            d: k
        ...
        K.pie.prototype.placeDataLabels = function() {
        ...
        }, K.pie.prototype.alignDataLabel = pa, K.pie.prototype.verifyDataLabelOverflow = function(a) {
            var b = this.center,
                c = this.options,
                d = c.center,
                e = c.minSize || 80,
            ...
            d[1] !== null ? f = s(E(f, b[2] - s(a[0], a[2])), e) : (f = s(E(f, b[2] - a[0] - a[2]), e),
                b[1] += (a[0] - a[2]) / 2);
        ...
        b.prototype.hideOverlappingLabels = function(a) {
            ...
            for (e = 0; e < b; e++) {
                j =
                    a[e];
                for (d = e + 1; d < b; ++d)
                    if (k = a[d], j && k && j.placed && k.placed && j.newOpacity !== 0 && k.newOpacity !== 0 && (l = j.alignAttr, m = k.alignAttr, o = j.parentGroup, q = k.parentGroup, r = 2 * (j.box ? 0 : j.padding), l = !(m.x + q.translateX > l.x + o.translateX + (j.width - r) || m.x + q.translateX + (k.width - r) < l.x + o.translateX || m.y + q.translateY > l.y + o.translateY + (j.height - r) || m.y + q.translateY + (k.height - r) < l.y + o.translateY)))(j.labelrank < k.labelrank ? j : k).newOpacity = 0
            }
            c(a, function(a) {
                var b, c;
                if (a) {
    ...
    var ob = z.TrackerMixin = {
        ...
        drawTrackerGraph: function() {
            ...
            if (e && !c)
                for (k = e + 1; k--;) d[k] ===
                    "M" && d.splice(k + 1, 0, d[k + 1] - i, d[k + 2], "L"), (k && d[k] === "M" || k === e) && d.splice(k, 0, "L", d[k - 2] + i, d[k - 1]);
            j ? j.attr({
                d: d
        ...
        pan: function(a, b) {
            ...
            n(b === "xy" ? [1, 0] : [1], function(b) {
                var b = c[b ? "xAxis" : "yAxis"][0],
                    ...
                    i = i > h;
                if (b.series.length && (i || l > E(k.dataMin, k.min)) && (!i || j < s(k.dataMax, k.max))) b.setExtremes(l, j, !1, !1, {
                    trigger: "pan"
                }), e = !0;
                c[d] = h
            });
        ...
        select: function(a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect", {
                ...
                b || n(e.getSelectedPoints(), function(a) {
                    if (a.selected &&
                        a !== c) a.selected = a.options.selected = !1, d.options.data[qa(a, d.data)] = a.options, a.setState(""), a.firePointEvent("unselect")
                })
            })
        },
    ...
    S(F.prototype, "getTimeTicks", function(a, b, c, d, e, f, g, h) {
        ...
        if (!this.options.ordinal && !this.options.breaks ||
            !f || f.length < 3 || c === u) return a.call(this, b, c, d, e);
        o = f.length;
        for (j = 0; j < o; j++) {
            q = j && f[j - 1] > d;
            f[j] < c && (i = j);
        ...
        if (h && t(p)) {
            ...
            j = [];
            var v;
            for (m = []; h--;) i = this.translate(r[h]),
                v && (m[h] = v - i), j[h] = v = i;
            m.sort();
            m = m[U(m.length / 2)];
            m < p * 0.6 && (m = null);
            h = r[a - 1] > d ? a - 1 : a;
            for (v = void 0; h--;) i = j[h], d = v - i, v && d < p * 0.8 && (m === null || d < m * 0.8) ? (l[r[h]] && !l[r[h + 1]] ? (d = h + 1, v = i) : d = h, r.splice(d, 1)) : v = i
        }
        return r
    });
    w(F.prototype, {
        beforeSetTickPositions: function() {
            ...
            if ((e = this.options.ordinal) || i) {
                ...
                c ? (this.ordinalPositions = b, d = this.val2lin(s(f, b[0]), !0), h = s(this.val2lin(E(g, b[b.length - 1]), !0), 1), this.ordinalSlope = g = (g - f) / (h - d), this.ordinalOffset = f - d * g) : this.ordinalPositions = this.ordinalSlope = this.ordinalOffset = u
            }
            this.isOrdinal = e && c;
        ...
        if (c.options.ordinal && c.series.length) {
            ...
            if (m.ordinalPositions) {
                if (Q(f) > 1) k && n(k, function(a) {
                    a.setState()
                }), f < 0 ? (k = m, q = c.ordinalPositions ? c : m) : (k =
                    c.ordinalPositions ? c : m, q = m), m = q.ordinalPositions, h > m[m.length - 1] && m.push(h), this.fixedRange = j - i, f = c.toFixedRange(null, null, l.apply(k, [o.apply(k, [i, !0]) + f, !0]), l.apply(q, [o.apply(q, [j, !0]) + f, !0])), f.min >= E(g.dataMin, i) && f.max <= s(h, j) && c.setExtremes(f.min, f.max, !0, !1, {
                    trigger: "pan"
    ...
    P.prototype.gappedPath = function() {
        var a = this.options.gapSize,
            ...
            d;
        if (a)
            for (d = c.length - 1; d--;) c[d + 1].x - c[d].x > b.closestPointRange * a && c.splice(d + 1, 0, {
                isNull: !0
            });
            ...
            if (this.options.breaks) {
                ...
                this.setAxisTranslation = function(a) {
                    ...
                    var b = d.options.breaks,
                        ...
                        j = d.userMax || d.max,
                        m, l;
                    for (l in b) g = b[l], f = g.repeat || Infinity, d.isInBreak(g, k) && (k += g.to % f - k % f), d.isInBreak(g, j) && (j -= j % f - g.from % f);
                    for (l in b) {
                        g = b[l];
                        m = g.from;
                    ...
                    for (l in a) {
                        ...
                        b === 0 && (c.push({
                            from: m,
                            to: g.value,
                            len: g.value - m - (g.size || 0)
                        }), e += g.value - m - (g.size || 0))
                    }
                    d.breakArray = c;
                    h(d, "afterBreaks");
    ...
    var ga = P.prototype,
        ...
        Va = {
            ...
            low: function(a) {
                return a.length ? Pa(a) : a.hasNulls ? null : u
            },
            close: function(a) {
    ...
    ga.groupData = function(a, b, c, d) {
        ...
        for (; n <= i; n++) {
            for (; c[1] !== u && a[n] >= c[1] || n === i;)
                if (j = c.shift(), k = d.apply(0, m), k !== u && (g.push(j), h.push(k)), m[0] = [], m[1] = [], m[2] = [], m[3] = [], n === i) break;
            if (n === i) break;
            if (o) {
                j = this.cropStart + n;
        ...
        if (dc.apply(this, arguments) !== !1 && c) {
            ...
            if (i) {
                ...
                var j = a.getExtremes(),
                    ...
                    g = i * (j - c) / g * h,
                    i = a.getTimeTicks(a.normalizeTimeTickInterval(g, b.units || Zb), Math.min(c, e[0]), Math.max(j, e[e.length - 1]), a.options.startOfWeek, e, this.closestPointRange),
    ...
    S(Mb.prototype, "tooltipFooterHeaderFormatter", function(a, b, c) {
        var d = b.series,
            ...
            g = e.xDateFormat,
            h, i = d.xAxis;
        return i && i.options.type === "datetime" && f && ta(b.key) ? (a = d.currentDataGrouping, f = f.dateTimeLabelFormats, a ? (i = f[a.unitName], a.count === 1 ? g = i[0] : (g = i[1], h = i[2])) : !g && f && (g = this.getXDateFormat(b, e, i)), g = la(g, b.key), h && (g += la(h, b.key + a.totalRange - 1)), Ka(e[(c ? "footer" : "header") + "Format"], {
            point: w(b, {
                key: g
            }),
            series: d
    ...
    ba = ka(ba, {
        ...
        drawPoints: function() {
            ...
            n(a.points, function(n) {
                m = n.graphic;
                if (n.plotY !== u) c = n.pointAttr[n.selected ? "selected" : ""] || d, k = c["stroke-width"] % 2 / 2, l = y(n.plotX) - k, e = n.plotOpen, f = n.plotClose, g = X.min(e, f), h = X.max(e,
                    f), q = y(n.shapeArgs.width / 2), i = y(g) !== y(n.plotY), j = h !== n.yBottom, g = y(g) + k, h = y(h) + k, o = ["M", l - q, h, "L", l - q, g, "L", l + q, g, "L", l + q, h, "Z", "M", l, g, "L", l, i ? y(n.plotY) : g, "M", l, h, "L", l, j ? y(n.yBottom) : h], m ? m.attr(c).animate({
                    d: o
    ...
    K.flags = ka(K.column, {
        ...
        translate: function() {
            ...
            if (e && e.visible && i) {
                ...
                for (a = "plot" + a[0].toUpperCase() + a.substr(1); i-- && c[d];)
                    if (e = c[d], l = h[i], l.x <= e.x && l[a] !== void 0) {
                        if (e.x <= m) e.plotY = l[a], l.x < e.x && !g && (o = h[i + 1]) && o[a] !== u && (e.plotY += (e.x - l.x) / (o.x - l.x) * (o[a] - l[a]));
                        d--;
                        i++;
                        if (d < 0) break
                    }
            ...
            n(c, function(a, d) {
                var e;
                if (a.plotY === u) a.x >= k.min && a.x <= k.max ? a.plotY =
        ...
        drawPoints: function() {
            var a, b = this.pointAttr[""],
                ...
                i, j, k, l, m, o;
            for (j = c.length; j--;)
                if (k = c[j], a = k.plotX > this.xAxis.len, e = k.plotX, e > 0 && (e -= p(k.lineWidth, g.lineWidth) % 2), l = k.stackIndex, i = k.options.shape || g.shape, f = k.plotY, f !== u && (f = k.plotY + h - (l !== u && l * g.stackDistance)),
                    m = l ? u : k.plotX, o = l ? u : k.plotY, l = k.graphic, f !== u && e >= 0 && !a) a = k.pointAttr[k.selected ? "select" : ""] || b, l ? l.attr({
                    x: e,
                    y: f,
                    r: a.r,
                    anchorX: m,
                    anchorY: o
                }) : k.graphic = d.label(k.options.title || g.title || "A", e, f, i, m, o, g.useHTML).css(C(g.style, k.style)).attr(a).attr({
    ...
    $a === z.VMLRenderer && n(["flag", "circlepin", "squarepin"], function(a) {
        nb.prototype.symbols[a] = wb[a]
    });
    var ba = [].concat(Zb),
        xb = function(a) {
            var b = Ma(arguments, function(a) {
                return typeof a === "number"
            });
    ...
    Ib.prototype = {
        ...
        drawScrollbarButton: function(a) {
            ...
            this.rendered || (d[a] = b.g().add(this.scrollbarGroup), g = b.rect(-0.5, -0.5, e + 1, e + 1, f.buttonBorderRadius, f.buttonBorderWidth).attr({
                ...
                3, "L", e / 2 + (a ? -1 : 1), e / 2 + 3, e / 2 + (a ? 2 : -2), e / 2
            ]).attr({
                ...
                if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    if (!this.rendered) {
                        if (z) this.navigatorGroup = l = f.g("navigator").attr({
                            ...
                            fill: A.maskFill
                        }).add(l), A.maskInside ? this.leftShade.css({
                            cursor: "ew-resize"
                        ...
                        if (r) this.scrollbarGroup = k = f.g("scrollbar").add(), m = u.trackBorderWidth, this.scrollbarTrack = o = f.rect().attr({
                            x: 0,
                            y: -m % 2 / 2,
                            ...
                            y: -H % 2 / 2,
                            height: n,
                            fill: u.barBackgroundColor,
                            stroke: u.barBorderColor,
                            "stroke-width": H,
                            r: I
                    ...
                    if (z) {
                        ...
                        this.outline[e]({
                            d: ["M", i, F, "L", g + b - B, F, g + b - B, F + G, "L", g + c - B, F + G, "L", g + c - B, F, i + j, F].concat(A.maskInside ? ["M", g + b + B, F, "L", g + c - B, F] : [])
                        });
                    ...
                    if (r && k) this.drawScrollbarButton(0), this.drawScrollbarButton(1), k[e]({
                        ...
                        width: j
                    }), g = n + b, h = a - H, h < v && (D = (v - h) / 2, h = v, g -= D), this.scrollbarPad = D, m[e]({
                        x: U(g) + H %
                            2 / 2,
                        width: h
                    }), v = n + b + a / 2 - 0.5, this.scrollbarRifles.attr({
                        visibility: a > 12 ? "visible" : "hidden"
                    })[e]({
                        d: ["M", v - 3, n / 4, "L", v - 3, 2 * n / 3, "M", v, n / 4, "L", v, 2 * n / 3, "M", v + 3, n / 4, "L", v + 3, 2 * n / 3]
                    });
                    this.scrollbarPad = D;
                    this.rendered = !0
                }
        ...
        init: function() {
            ...
            a.mouseDownHandler = function(d) {
                var d = b.pointer.normalize(d),
                    ...
                    y, z = lb ? 10 : 7;
                if (w > h && w < h + g + k)
                    if ((h = !a.scrollbarEnabled || w < h + g) && X.abs(u - e - n) < z) a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null;
                    else if (h && X.abs(u - f - n) < z) a.grabbedRight = !0, a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null;
                else if (u > n + e - t && u < n + f + t) a.grabbedCenter = u, a.fixedWidth = s, i = u - e;
                else if (u > j && u < j + l) {
                    f = h ? u - n - s / 2 : u < n ? e - s * 0.2 : u > j + l - k ? e + s * 0.2 : u < n + e ? e - s : f;
                    if (f < 0) f = 0;
                    else if (f + s >= p) f = p - s, y = a.getUnionExtremes().dataMax;
                    if (f !==
                        e) a.fixedWidth = s, e = c.toFixedRange(f, f + s, null, y), d.setExtremes(e.min, e.max, !0, !1, {
                        trigger: "navigator"
                    })
                }
            };
            a.mouseMoveHandler = function(c) {
                var d = a.scrollbarHeight,
                    ...
                    k = a.range,
                    j, l;
                if (!c.touches || c.touches[0].pageX !== 0) c = b.pointer.normalize(c), j = c.chartX, j < e ? j = e : j > g + h - d && (j = g + h - d), a.grabbedLeft ? (l = !0, a.render(0, 0, j - e, a.otherHandlePos)) : a.grabbedRight ? (l = !0, a.render(0, 0, a.otherHandlePos, j - e)) : a.grabbedCenter && (l = !0, j < i ? j = i : j > f + i - k && (j =
                    f + i - k), a.render(0, 0, j - i, j - i + k)), l && a.scrollbarOptions.liveRedraw && setTimeout(function() {
                    a.mouseUpHandler(c)
                }, 0), a.hasDragged = l
            };
            a.mouseUpHandler = function(d) {
                ...
                if (a.hasDragged) {
                    ...
                    t(e.min) && b.xAxis[0].setExtremes(e.min, e.max, !0, !1, {
                        trigger: "navigator",
            ...
            a.navigatorEnabled ? (a.xAxis = c = new F(b, C({
        ...
        getUnionExtremes: function(a) {
            ...
            if (!a || b.dataMin !== null) f = {
                dataMin: p(d && d.min, xb("min",
                    e.min, b.dataMin, c.dataMin)),
        ...
        addBaseSeries: function() {
            ...
            if (a && this.navigatorOptions.adaptToUpdatedData !== !1) D(a, "updatedData", this.updatedDataHandler), a.userOptions.events = w(a.userOptions.event, {
        ...
        updatedDataHandler: function() {
            ...
            i && (l = g, k = l + h);
            j && (k = d, i || (l = s(k - h, n.xData[0])));
            q && (i || j) ? isNaN(l) || c.setExtremes(l, k, !0, !1, {
                trigger: "updatedData"
            }) : (m && this.chart.redraw(!1), a.render(s(e, g), E(f, d)))
        },
        destroy: function() {
            this.removeEvents();
            n([this.xAxis, this.yAxis, this.leftShade, this.rightShade, this.outline, this.scrollbarTrack, this.scrollbarRifles,
                this.scrollbarGroup, this.scrollbar
            ], function(a) {
    ...
    S(P.prototype, "addPoint", function(a, b, c, d, e) {
        ...
        f && this.xData.length > f && fa(b) && !Na(b) && this.chart.scroller &&
            ea(20, !0);
        a.call(this, b, c, d, e)
    });
    w(O, {
    ...
    Jb.prototype = {
        clickButton: function(a, b) {
            var c = this,
                ...
                j = i.dataMin,
                k = i.dataMax,
                l, m = h && y(E(h.max, p(k, h.max))),
                o = g.type,
                q, i = g._range,
                r, t, w, v = g.dataGrouping;
            if (!(j === null || k === null || a === c.selected)) {
                e.fixedRange = i;
                if (v) this.forcedDataGrouping = !0, F.prototype.setDataGrouping.call(h || {
                    chart: this.chart
                }, v, !1);
                if (o === "month" || o === "year")
                    if (h) {
                        if (o = {
                                ...
                                dataMin: j,
                                dataMax: k
                            }, l = h.minFromRange.call(o), typeof o.newMax === "number") m = o.newMax
                    } else i =
                        g;
                else if (i) l = s(m - i, j), m = E(l + i, k);
                else if (o === "ytd")
                    if (h) {
                        if (k === u) j = Number.MAX_VALUE, k = Number.MIN_VALUE, n(e.series, function(a) {
                            a = a.xData;
                            j = E(a[0], j);
                            k = s(a[a.length - 1], k)
                        }), b = !1;
                ...
                h ? (h.setExtremes(l, m, p(b, 1), 0, {
                    ...
                    (q = e.options.xAxis[0], w = q.range, q.range = i, t = q.min, q.min = r, c.setSelected(a), D(e, "load", function() {
                        q.range = w;
                        q.min = t
                    }))
            }
        ...
        updateButtonStates: function(a) {
            ...
            n(b.buttonOptions, function(a, e) {
                ...
                w || n && e !== h && e === b.lastSelected ? (b.setSelected(e), j[e].setState(2)) : !i && (t || s || u || x || z) ? j[e].setState(3) : j[e].state === 3 && j[e].setState(0)
            })
        },
        ...
        setInputValue: function(a, b) {
            ...
            this[a + "DateBox"].attr({
                text: la(c.inputDateFormat || "%b %e, %Y", this[a + "Input"].HCTime)
            })
        },
        ...
        drawInput: function(a) {
            ...
            this[a + "Label"] = j = e.label(O.lang[h ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).attr({
                padding: 2
            }).css(C(d, f.labelStyle)).add(k);
            k.offset += j.width + 5;
            ...
            i.onchange = function() {
                ...
                isNaN(d) || (O.global.useUTC || (d += (new da).getTimezoneOffset() * 6E4), h ? d > b.maxInput.HCTime ? d = u : d < g && (d = g) : d < b.minInput.HCTime ? d = u : d > j && (d = j), d !== u && c.xAxis[0].setExtremes(h ? d : e.min, h ? e.max : d, u, u, {
        ...
        getPosition: function() {
            var a = this.chart,
                ...
                a =
                p((b.buttonPosition || {}).y, a.plotTop - a.axisOffset[0] - b.height);
            return {
                buttonTop: a,
                inputTop: a - 10
            }
        ...
        render: function(a, b) {
            var c = this,
                ...
                q = l && l.states,
                r = d.plotLeft,
                s, u = this.getPosition(),
                v = c.group,
                x = c.rendered;
            if (!x && (c.group = v = e.g("range-selector-buttons").add(), c.zoomText = e.text(g.rangeSelectorZoom,
                    p(m.x, r), 15).css(i.labelStyle).add(v), s = p(m.x, r) + c.zoomText.getBBox().width + 5, n(c.buttonOptions, function(a, b) {
                ...
                }), c.updateButtonStates(), o !== !1)) c.div = k = ca("div", null, {
                    position: "relative",
                    height: 0,
                    zIndex: 1
                }), f.parentNode.insertBefore(k, f), c.inputGroup = k = e.g("input-group").add(), k.offset = 0, c.drawInput("min"),
                c.drawInput("max");
            v[x ? "animate" : "attr"]({
                translateY: u.buttonTop
            });
            o !== !1 && (k.align(w({
                y: u.inputTop,
                width: k.offset,
                x: h && u.inputTop < (h.y || 0) + h.height - d.spacing[0] ? -40 : 0
            }, i.inputPosition), !0, d.spacingBox), t(o) || (d = v.getBBox(), k[k.translateX < d.x + d.width + 10 ? "hide" : "show"]()), c.setInputValue("min", a), c.setInputValue("max", b));
            c.rendered = !0
        },
        destroy: function() {
            var a = this.minInput,
    ...
    z.StockChart = z.stockChart = function(a, b, c) {
        ...
        e.xAxis = ra(ua(e.xAxis || {}), function(a) {
            return C({
                minPadding: 0,
                maxPadding: 0,
                ordinal: !0,
        ...
        e.yAxis = ra(ua(e.yAxis || {}), function(a) {
            g = p(a.opposite, !0);
            return C({
                labels: {
                    y: -2
    ...
    S(F.prototype, "getPlotLinePath", function(a, b, c, d, e, f) {
        ...
        w = g.isXAxis ? t(g.options.yAxis) ? [i.yAxis[g.options.yAxis]] : ra(h, function(a) {
                return a.yAxis
            }) : t(g.options.xAxis) ? [i.xAxis[g.options.xAxis]] :
            ra(h, function(a) {
                return a.xAxis
            });
        ...
        isNaN(x) || (g.horiz ? n(v, function(a) {
            var b;
            o = a.pos;
            r = o + a.len;
            m = q = y(x + g.transB);
    ...
    xa.prototype.crispPolyLine =
        function(a, b) {
            var c;
            for (c = 0; c < a.length; c += 6) a[c + 1] === a[c + 4] && (a[c + 1] = a[c + 4] = y(a[c + 1]) - b % 2 / 2), a[c + 2] === a[c + 5] && (a[c + 2] = a[c + 5] = y(a[c + 2]) + b % 2 / 2);
            return a
        };
    ...
    ga.processData = function() {
        ...
        if (this.xAxis && this.processedYData) {
            ...
            for (a = 0; a < e; a++)
                if (f = b > -1 ? d[a][b] : d[a], typeof f === "number" &&
                    c[a] >= this.xAxis.min && f !== 0) {
                    this.compareValue = f;
                    break
                }
        }
    ...
    S(ga, "getExtremes", function(a) {
        ...
        if (this.modifyValue) b = [this.modifyValue(this.dataMin), this.modifyValue(this.dataMax)], this.dataMin = Pa(b), this.dataMax = Ea(b)
    });
    ...
    S(P.prototype, "render", function(a) {
        if (this.chart.options._stock && this.xAxis) !this.clipBox && this.animate ? (this.clipBox = C(this.chart.clipBox), this.clipBox.width = this.xAxis.len, this.clipBox.height = this.yAxis.len) : this.chart[this.sharedClipKey] && (Ta(this.chart[this.sharedClipKey]), this.chart[this.sharedClipKey].attr({
