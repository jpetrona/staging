...
<link href='//fonts.googleapis.com/css?family=Open+Sans:400,300,600,700,800,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>
<link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri()); ?>/css/font-awesome.min.css">
<link href='//fonts.googleapis.com/css?family=Open+Sans:400,600,700,800,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>
    ...
    <!--Donwload Btn link-->
     <div class="download-store-btn">
         <ul>
            ...
            <li><a href="https://play.google.com/store/apps/details?id=com.Intlfaces.retire.ly"><img src="<?php echo esc_url(get_template_directory_uri());?>/images/google-play-white.svg" class="img-responsive social-img-icon"></a></li>
            <li><a href="https://itunes.apple.com/us/app/retirely/id713998164?ls=1&mt=8"><img src="<?php echo esc_url(get_template_directory_uri());?>/images/apple-button-white.svg" class="img-responsive social-img-icon"></a></li>
          </ul>
        </div>
