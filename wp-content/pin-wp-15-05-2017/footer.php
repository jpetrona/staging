...
<footer>
    <div class="footer-socila-butn">
        <div style="width: 30%;float: left;margin-left: 10px;font-weight: bold;margin-top: 12px;">
            Are you an advisor? Read how we can benefit you <a target="_blank" href="<?php echo get_option('home'); ?>/financialadvisors">here</a>
        </div>
        <ul style="width: 39%;float: left;">
           <li><a href="https://play.google.com/store/apps/details?id=com.Intlfaces.retire.ly"><img src="<?php echo get_template_directory_uri();?>/images/google-play-white.svg" class="img-responsive social-img-icon"></a></li>
           <li><a href="https://itunes.apple.com/us/app/retirely/id713998164?ls=1&mt=8"><img src="<?php echo get_template_directory_uri();?>/images/apple-button-white.svg" class="img-responsive social-img-icon"></a></li>   
        </ul>
    </div>
    <div class="social-section">
        <!-- footer social icons. -->
        <div style="width:33%;float: left;margin-top: 2%;">
            <div style="width:50%;float:left;font-weight: bold;"><a href="<?php echo get_option('home'); ?>/about-us">ABOUT US</a></div>
            <div style="width:50%;float:left;font-weight: bold;"><a href="<?php echo get_option('home'); ?>/contact-us">CONTACT US</a></div>
        </div>
        ...
        <div style="width:32%;float: left;margin-top: 2%;">
            <div style="width:50%;float:left;font-weight: bold;"><a href="<?php echo get_option('home'); ?>/privacy-policy">PRIVACY POLICY</a></div>
            <div style="width:50%;float:left;font-weight: bold;"><a href="<?php echo get_option('home'); ?>/terms-of-service">TERMS</a></div>
        </div>
    </div>
...
jQuery(document).ready(function() {
    ...
    function creategraph(symbol) {
        ...
        var url = "//api.stocktwits.com/api/2/streams/symbol/" + symbol + ".json";
        jQuery.getJSON(url, function(data) {
            // split the data set into ohlc and volume
            var ohlc = [],
                volume = [],
    ...
    function showingGraph(reference) {
        ...
        jQuery('.graphdynamic').css('margin-top', '-28px');
        myslider.stopAuto();
    }
    //});
