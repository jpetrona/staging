    ...
    <?php } else { 
        ...
        <div class="entry">
            ...
            <?php  $user_id = get_current_user_id(); 
                  ...
                  $opt =  getSinglePostLikeDislikecount(get_the_ID());
                  $post_counter =  $opt['like_counter']+$opt['dislike_counter'];
            ...
            <div class="watch-action">
                ...
                <div class="like-unlike-popup-sec" style="display:none;">
                    ...
                    <div class="like-unlike-popup-like">
                       <div class="rtl-like rtl-like-rtl-Dislike"> <p style="padding:0px 15px;">Like <?php echo $likedislike_count['like_counter'];?></p></div>
                    ...
                    <div class="like-unlike-popup-unlike">
                        <div class="rtl-Dislike rtl-like-rtl-Dislike"><p style="padding:0px 15px;">Dislike <?php echo $likedislike_count['dislike_counter'];?></p></div>
                        <ul class="like-unlike-popup-list">
