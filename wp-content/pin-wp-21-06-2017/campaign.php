...
$get_url = "https://dashboard.retire.ly/user-campaign".$request_url[3]."#/addFunds";
}else{
$get_url = "https://dashboard.retire.ly/user-campaign".$request_url[3];
}
?>
<!-- Begin Content -->
...
<span id="iframeloading"></span>
    <div class = "wrap-content" style = "margin-left: 12%;background-color: transparent;" > 
        <?php if(isset($_GET['id']) && $_GET['id'] != ''){
         ...
         ?>
       <object id="addCampaignIframe"  data="<?php echo $get_url;?>" style="width:83.5%;margin-left:2%; margin-right:auto; ">
