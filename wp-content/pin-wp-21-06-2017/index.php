<?php
$fark_flag = true;
//$fark_data = file_get_contents("//news.fark.com/data/js/84115.js");
...
<?php } ?>
 <div id= "fc_popup" class="fc-popup" style="display:none;" >
 <div class="fc-overlay"></div>
  <div class="main-block">
  <a class="fc-close" href="javascript:void(0);">
<svg class="bx-close-xsvg" viewBox="240 240 20 20"><g class="bx-close-xstroke bx-close-x-adaptive"><path class="bx-close-x-adaptive-1" d="M255.6 255.6l-11.2-11.2" vector-effect="non-scaling-stroke"></path><path class="bx-close-x-adaptive-2" d="M255.6 244.4l-11.2 11.2" vector-effect="non-scaling-stroke"></path></g></svg>
    ...
    <center><img class="popup-logo-type" height="150px" src="https://www.retire.ly/wp-content/themes/pin-wp/images/retire-app.svg"></center>
    <div class="block-pop fc-advisor">
      <h1 class="fc-title">If you are looking for an advisor, Install the App or <a class="fc-link" href="Javascript:void(0);">continue to read our News</a> </h1> 
    </div>
  <div class="block-pop fc-investers">
       <h1 class="fc-title"> If you are a Financial Advisor seeking to get in front of our audience , <a class="fc-click" target="_blank" href="https://www.retire.ly/financialadvisors/">Click Here</a>. Or <a class="fc-link" href="javascript:void(0);">continue to read our News  </a>  </h1><center> <a class="in-btn" href="https://itunes.apple.com/us/app/retirely/id713998164?ls=1&mt=8"> <img width="200px" src="<?php echo get_template_directory_uri().'/images/apple-button-white.svg'?>"></a> 
       <a class="in-btn" href="https://play.google.com/store/apps/details?id=com.Intlfaces.retire.ly"> <img width="200px" src="<?php echo get_template_directory_uri().'/images/google-play-white.svg'?>"></a> 
       </center>
    </div>
  </div>
  </div>
...
$(document).ready(function() {
  $(".fc-close,.fc-link").click(function() {
     $("#fc_popup").hide();
    });
});
</script>
...
<?php if($user_id_val==""){?>
	<div class="arrow-logo"   >
		...
		<a href="https://idealmedia.com/" target="_blank"><img class="arrow-logo-img" title="Ideal Media" src="<?php echo get_template_directory_uri().'/images/Ideal-new.svg';  ?>"></a>
    ...
    <div class="template-cat" style="min-height:27px;" >
      <span class="template-cat-getting" style="display:none;" >
       ...
       <!-- <span class="cat">All posts in:</span>-->
        ...
        <select id="template-category" class="template-category" >
        ...
        <?php $num=0;  if (have_posts()) : while (have_posts()) : the_post(); $num++; ?>
            ...
            <li <?php post_class('ex34') ?> id="post-<?php the_ID(); ?>">
                ...
                <?php } else{ $video_source =  get_post_meta( get_the_ID(), 'video_source', true ); 
                     ...
                     ?>
                    <div class="video_loader <?php echo $twiter_flag == 1 ? 'section_show': 'section_hide'; ?>">
                    <img class="video-loader-img" src="//lh3.googleusercontent.com/-Pz0C9KoJJ1k/WSws85PE3QI/AAAAAAAABrE/h4LNloGmUnshaijfdIL7hTms07P5D7UPACL0B/h204/2017-05-29.gif"></div> 
               ...
               <div class="overlay-mask"></div></a>
                ...
                <div class="small-content">
                 ...
                 <div class="source-left">
                    ...
                    <span class="vcard author home-author"><div></div></span>
                    <div class="article-comm"></div>
                    <div class="index-article-source home-source-image"></div>
                    <div class="posting-author">
                    <span style="font-size:14px;color:blue;font-family: 'Open Sans', Times, serif;"></span></div>
