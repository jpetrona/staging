              ...
              <article>
                  <div class="frontend-post post type-post status-publish format-standard has-post-thumbnail hentry category-business">
                    ...
                    <div class="ct-size graph-ct-size">
                        ...
                        <div class="ct-size"><div class="entry-btn">Article Categories:</div> <a style="color:#2B00F7;" rel="category tag" href="<?php echo get_category_link( $category ); ?>"><?php echo get_cat_name( $category ) ?></a></div>
                    </div>
                  </div>
              </article>
