	...
	*/
	...
	?>
	                ...
	                <html lang="en">
								...
								<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/js/jquery.selectbox-0.2.js"></script>
	...
	<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/js/ajax/jsDatePick.min.1.3.js"></script>
	      ...
	      <div class="campaign-stats" id="defaultcamp">
	         <ul>
	              <li><a class="step5" href="javascript:void(0);" tgt="#billing-summary" onClick="step5()">Total Funded
	                  <span class="figure"> $<?php echo number_format($fund); ?> </span></a></li>
	              <li><a class="step11" href="javascript:void(0);" tgt="#advertise-data" onClick="step11()">Running Campaign
	                <span class="figure" id="running_campaign">
						<?php 
	                        $admin_id = $_SESSION["advisorid"];
	                        if($admin_id == 172 ){
	...
	<div class="apps-content">
	   <div class="loader" style="display:none">
	         <img src="<?php bloginfo('template_directory'); ?>/images/loading1.gif" id="dvLoading">
	     </div>
	            <div id="add-product">
	            ...
	            <div id="advertise-data">
					<div>
						...
						<?php 
							...
							FROM ".RETIRELY_DB.".hasofferstats WHERE `offerurl` = '$url'";
