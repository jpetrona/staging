...
class anthemes_randreviews extends WP_Widget {
    function anthemes_randreviews() {
      $widget_ops = array('description' => esc_html__('Your site\'s Random Reviews.', 'anthemes'));
      parent::WP_Widget(false, $name = ''. esc_html__('Custom: Random Reviews', 'anthemes') .'',$widget_ops); 
    }
...
<?php  } } 
add_action('widgets_init', create_function('', 'return register_widget("anthemes_randreviews");')); // register widget
?>