...
class anthemes_300px extends WP_Widget {
     function anthemes_300px() {
	    $widget_ops = array('description' => esc_html__('Advertisement - Paste your HTML or JavaScript code.', 'anthemes'));
        parent::WP_Widget(false, $name = ''. esc_html__('Custom: Advertisement 300px', 'anthemes') .'',$widget_ops); 
    }
...
?>
        ...
        <p>
          <label for="<?php echo $this->get_field_id('bcode'); ?>"><?php esc_html_e( 'Paste your HTML or JavaScript code here:', 'anthemes' ); ?></label>      
