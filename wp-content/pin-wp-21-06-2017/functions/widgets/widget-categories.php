...
class anthemes_categories extends WP_Widget {
     function anthemes_categories() {
	    $widget_ops = array('description' => esc_html__('Display Categories in 2 columns.', 'anthemes'));
        parent::WP_Widget(false, $name = ''. esc_html__('Custom: Categories', 'anthemes') .'',$widget_ops); 
    }
