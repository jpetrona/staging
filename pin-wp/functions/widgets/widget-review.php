...
class anthemes_bestreviews extends WP_Widget {
    function anthemes_bestreviews() {
      $widget_ops = array('description' => esc_html__('Your site\'s Best Reviews.', 'anthemes'));
      parent::WP_Widget(false, $name = ''. esc_html__('Custom: Best Reviews', 'anthemes') .'',$widget_ops); 
    }
