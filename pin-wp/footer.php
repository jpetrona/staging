...
jQuery(document).ready(function() {
    ...
    jQuery('body').on('mouseenter', '.frondendgraph, .frondendgraph1', function(e,index) {
        ...
        // jQuery(selectorClass).find(".graph-strip, .stockname_heading").on('mouseenter', function(index) {
        // 	alert('test');
        //    return false;
        // });
