...
<div class="entry-bottom">
    ...
    <?php if (get_comments_number()==0) {  ?>
     ...
     <h3 class="single-title cmnt-text"> <?php if(get_comments_number()>1){esc_html_e( 'Comments', 'anthemes' );}else{esc_html_e( 'Comment', 'anthemes' );} ?>  
        ...
        <div class="related-box">
            ...
            <?php while ( $anposts->have_posts() ) : $anposts->the_post(); ?>
              ...
              <li>
                ...
                <?php } ?>
                <?php $video_source = get_field('video_source'); ?>
                  <?php if(isset($video_source) && $video_source != '' && !has_post_thumbnail( get_the_ID() ) ) { ?> 
                     <img src="https://d3aauwrblcdnb4.cloudfront.net/wp-content/uploads/2016/09/08110551/play-icon-e1473332819792.png"/>
                  <?php }?> 
