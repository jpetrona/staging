                        ...
                        <div class="entry">
                          ...
                          <div class="clear"></div>
                           ...
                           <div class="error">
                              ...
                              <div class="boxerror">
                                <span><?php esc_html_e('Sorry, an error occured.', 'anthemes'); ?></span>
                              </div>
                              <?php } ?>
                           </div>
                            ...
                            <fieldset id="contactform">                                      
                             ...
                             <div class="one_half_c">
                                 <label for="contactName"><?php esc_html_e('Name:', 'anthemes'); ?><span>*</span></label>
                             ...
                             <div class="one_half_last_c">
                                 <label for="emaill"><?php esc_html_e('Email:', 'anthemes'); ?><span>*</span></label>
                             ...
                             <div class="one_full_c">
                                 <label for="subject"><?php esc_html_e('Subject:', 'anthemes'); ?><span>*</span></label>
                             ...
                             <div class="one_full_c">
                                 <label for="comments"><?php esc_html_e('Message:', 'anthemes'); ?><span>*</span> </label>
                                ...
                                <input type="submit" name="submit" class="sendemail" value="<?php esc_html_e('Submit Message', 'anthemes'); ?>"  /> <span>*</span><?php esc_html_e('All Fields are mandatory!', 'anthemes'); ?>
