<div class="wrap" id="of_container">
	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="header">
			...
			<div class="clear"></div>
			<!-- delete this -->
				<a style="margin:13px 0 0 50px !important; background-color: #cc3333; border: 1px solid #cc3333 !important; color: #FFF !important; text-shadow: 0 -1px 0 #cc3333;" href="http://themeforest.net/user/An-Themes/portfolio" target="_blank" class="button-primary"><?php _e('Themes', 'anthemes');?></a>
				<a style="margin:13px 0 0 2px !important; background-color: #3b3b3b; border: 1px solid #3b3b3b !important; color: #FFF !important; text-shadow: 0 -1px 0 #3b3b3b;" href="http://themeforest.net/user/An-Themes" target="_blank" class="button-primary"><?php _e('Support', 'anthemes');?></a>		
    		<!-- delete this -->
    	</div>
